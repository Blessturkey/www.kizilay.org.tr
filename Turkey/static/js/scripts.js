						...
						var	_t 					= jQuery(this),
							...
							var _typeahead = new Bloodhound({
								...
								remote: {
                                    url: _qryURL + '%QUERY',
									wildcard: '%QUERY',
									filter: function (sonuclar) {
										// Map the remote source JSON array to a JavaScript object array
										return $.map(sonuclar, function (sonuc) {
											return {
												value: sonuc.value,
												id: sonuc.id
											};
							...
							},
							{
								...
								templates: {
									...
									suggestion: function (data) {
										return '<div><img height:"16px" width:"16px" src="/Images/ico-hizliarama.png"> ' + data.value + '</div> ';
									}
								}
							});
							/** **/
